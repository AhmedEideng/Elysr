    ...
    const staticRoutes = [
      ...
      },
      {
        ...
        body:
          ...
          "<p>نستخدم بيانات الطلب حصرياً لتنفيذ طلبك والتواصل معك حوله. <strong>لا نبيع بياناتك الشخصية ولا نشاركها مع أي طرف لأغراض تسويقية</strong> — هذا التزام قاطع. وفي الوقت نفسه نوضح بدقة: بعض مُقدّمي الخدمات يعالجون بيانات تقنية/ملخصة تحت سياساتهم الخاصة دون أن تكون بيانات تعريفك أو تُستخدم للتواصل معك: Google Analytics (إحصائيات زيارة مجمعة)، وVercel (تحليلات أداء المنصة والأمان)، وGoogle Sheets (تخزين الطلبات التشغيلي). لا نرسل أي بيانات طلب شخصية إلى هذه الأدوات. يُحمَّل كود التحليل بعد تأجيل قصير ويعمل دون كوكيز تعريفية، ويمكنك منعه من إعدادات المتصفح دون تأثر استخدامك للموقع.</p>" +
