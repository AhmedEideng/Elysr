    ...
    const staticRoutes = [
      ...
      },
      {
        ...
        body:
          ...
          "<p>المحتوى الأصلي في الموقع كُتب شخصيًا من د. أحمد عيد — بكالوريوس صيدلة ومؤسس اليسر ميديكال — بمسؤوليته التحريرية المباشرة، ويعتمد على مصادر طبية معتمدة مثل منظمة الصحة العالمية ومayo Clinic وCleveland Clinic وMedlinePlus.</p>" +
          ...
          "<p>لا يوجد لدينا لجنة مراجعة طبية دائمة ولا فريق مراجعة داخلية بالمعنى المؤسسي ولا إعادة مراجعة دورية تلقائية. المحتوى المولّد آليًا (إن أُضيف) يُعلَن بوضوح كمولّد آليًا ولا يُنسب لأي شخص. سلامة عملائنا أولوية: لا نقدم تشخيصًا ولا وعودًا علاجية.</p>" +
      ...
      },
      {
        ...
        body:
          ...
          "<p>على مدار سنوات، بنينا سمعتنا على ثلاثة مبادئ ثابتة: الأصالة في المنتجات، والشفافية في المعلومات، واحترام خصوصية كل عميل. نختار منتجاتنا بعناية من موردين موثوقين، ويكتب محتوى منتجاتها د. أحمد عيد (صيدلي) بمسؤوليته التحريرية المباشرة مع تحقق آلي (CI) من المصادر والتحذيرات، ونلتزم بعدم تقديم وعود مبالغ فيها.</p>" +
    ...
    if (articles.length > 0) {
      ...
      for (const article of articles) {
        ...
        const articleJsonLd = {
          ...
          // عشان مفيش مزاعم مراجعة بشرية غير حقيقية في structured data.
          ...(article.autoReviewed
            ? {}
            : {
                reviewedBy: {
                  "@type": "Organization",
        ...
        const body = `
          <article>
            ...
            <section>
              ...
              <p>مراجعة: ${esc(article.reviewer?.name || "فريق المراجعة الداخلية — اليسر ميديكال")}</p>
