...
async function prerender() {
  ...
  try {
    ...
    /* ========== 1) Home page ========== */
    {
      const title = "اليسر — منتجات الصحة الزوجية الأصلية في مصر | دفع عند الاستلام";
      const desc =
      ...
      let html = buildHtml(template, {
        ...
        bodyContent: `<h1>اليسر — منتجات الصحة الزوجية الأصلية في مصر | دفع عند الاستلام</h1>
<p>${esc(desc)}</p>
    ...
    const staticRoutes = [
      ...
      },
      {
        ...
        body:
          ...
          "<h2>كيف نستخدم بياناتك ونحميها</h2>" +
          "<p>نستخدم بياناتك حصرياً لتنفيذ طلبك والتواصل معك حوله. لا نبيع بياناتك أو نشاركها مع أي طرف ثالث لأغراض تسويقية. نتعامل مع بياناتك بسرية تامة، ونحد من الوصول إليها لمن يحتاجها فقط لأداء مهامه.</p>" +
          "<h2>التغليف السري</h2>" +
          ...
          "<p>يمكنك طلب حذف بياناتك أو الاستفسار عن كيفية استخدامها في أي وقت عبر التواصل معنا.</p>",
      },
