...
async function prerender() {
  ...
  try {
    ...
    /* ========== 1) Home page ========== */
    {
      ...
      const desc =
        "اليسر هو أكبر متجر متخصص في منتجات الصحة الزوجية الأصلية للرجال والنساء في مصر. شحن سري 100%، دفع عند الاستلام، أكثر من 100 منتج مضمون ودعم متخصص على واتساب.";
  ...
  <li>تواصل مباشر عبر واتساب على مدار الساعة</li>
    ...
    const staticRoutes = [
      ...
      },
      {
        ...
        desc: "القواعد والشروط التي تحكم استخدامك لمتجر اليسر ميديكال.",
        h1: "الشروط والأحكام",
      },
      {
        path: "/privacy",
