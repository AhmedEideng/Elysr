    ...
    const staticRoutes = [
      ...
      },
      {
        ...
        body:
          ...
          "<p>كل عميل يحصل على كود إحالة فريد بعد الطلب. شارك رابطك مع الأصدقاء عبر واتساب. عندما يطلب صديقك عبر رابطك، يُسجل كودك في الطلب وستحصل على خصم في طلبك القادم.</p>" +
          "<h2>المميزات</h2>" +
