...
async function prerender() {
  ...
  try {
    ...
    /* ========== 1) Home page ========== */
    {
      const title = "اليسر — منتجات الصحة الزوجية الأصلية في مصر | شحن سري ودفع عند الاستلام";
      const desc =
        "اليسر هو أكبر شركة متخصصة في منتجات الصحة الزوجية الأصلية للرجال والنساء في مصر. شحن سري 100%، دفع عند الاستلام، أكثر من 100 منتج مضمون ودعم متخصص على واتساب.";
      let html = buildHtml(template, {
        ...
        bodyContent: `<h1>اليسر — منتجات الصحة الزوجية الأصلية في مصر | شحن سري ودفع عند الاستلام</h1>
<p>${esc(desc)}</p>
<h2>أقسام الشركة</h2>
<ul>
    ...
    const staticRoutes = [
      {
        ...
        desc: "تسوق منتجات الصحة الزوجية للرجال الأصلية في مصر: مكملات، عسل، جل وبخاخات مختارة بعناية مع شحن سري ودفع عند الاستلام.",
      ...
      },
      {
        ...
        desc: "أجهزة طبية ووسائل تأهيل مستوردة بضمان وجودة عالية بجودة مضمونة.",
        h1: "الأجهزة والمستلزمات الطبية",
      },
      {
        path: "/education",
        title: "التوعية الجنسية — مقالات علمية موثوقة | اليسر ميديكال",
        desc: `${articles.length || 18} مقال توعوي علمي عن الصحة الجنسية والعلاقات الزوجية بإشراف مختصين.`,
      ...
      },
      {
        ...
        desc: "تعرف على اليسر ميديكال، رحلتنا 10 سنوات في مجال الصحة الزوجية وثقة عملائنا في مصر.",
        h1: "عن اليسر ميديكال",
      },
      {
        path: "/contact",
        title: "تواصل معنا — اليسر ميديكال",
        desc: "تواصل مع فريق اليسر ميديكال عبر الواتساب أو البريد الإلكتروني للاستفسارات والطلبات.",
        h1: "تواصل معنا",
      },
      {
        path: "/shipping",
        title: "سياسة الشحن — اليسر ميديكال",
        desc: "تفاصيل خدمة الشحن السري لجميع محافظات مصر مع الدفع عند الاستلام.",
        h1: "سياسة الشحن",
      },
      {
        path: "/returns",
        title: "سياسة الاسترجاع — اليسر ميديكال",
        desc: "سياسة الاسترجاع والاستبدال في اليسر ميديكال.",
        h1: "سياسة الاسترجاع",
      },
      {
        path: "/terms",
        title: "الشروط والأحكام — اليسر ميديكال",
        desc: "القواعد والشروط التي تحكم استخدامك لشركة اليسر ميديكال.",
        h1: "الشروط والأحكام",
      },
      {
        path: "/privacy",
        title: "سياسة الخصوصية — اليسر ميديكال",
        desc: "سياسة خصوصية اليسر ميديكال — كيف نحمي بياناتك الشخصية.",
        h1: "سياسة الخصوصية",
      },
