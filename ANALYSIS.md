...
- الـ 56 مقالة الحالية: author "د. أحمد عيد (صيدلي)" + reviewer
...
3. **صفحة الشفافية** (/medical-review-board) اتكتبت من جديد حسب
   الواقع: من يكتب (د. أحمد عيد شخصيًا) + الفحص الآلي (CI) + **قسم
...
- **author**: "فريق المحتوى الصحي — اليسر ميديكال" /
  ...
  المسؤولية التحريرية المباشرة لد. أحمد عيد (صيدلي — مؤسس)،
