 ...
 *     يُخصم 20% من مجموع أسعار الوحدات (واحدة من كل عضو).
 *   - تُطبَّق أفضل باقة واحدة فقط (الأعلى قيمة) — حتمية وقابلة
 *     للتحقق الخلفي بدون أي ثقة في حساب العميل.
 *   - 🔀 الخصمان متبادلا الاستبعاد: عند اكتمال الباقة، خصم الباقة هو
 *     الخصم الوحيد المطبق على الطلب (خصم شرائح "مبادرة الرعاية الماسية"
 *     موقوف لهذا الطلب) — والعكس: من غير باقة مكتملة يعمل الخصم
 *     المتدرج كالمعتاد.
 *
...
/** نسبة خصم الباقة (20%) — نفس القيمة في السيرفر واختبارات السلامة. */
