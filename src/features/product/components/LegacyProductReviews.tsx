...
import { getProductReviews, type ProductCategory } from "@/lib/legacy-product-reviews";

export function LegacyProductReviews({
  rating,
  reviewsCount,
  category = "men",
  slug,
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-6 mb-8 border-b pb-8">
        <div className="text-center md:text-right">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            تجارب عملاء سابقة من جميع محافظات مصر
          </p>
        </div>
        ...
        <div className="flex flex-col items-center md:items-end">
          ...
          <p className="text-xs font-bold text-muted-foreground mt-1">
            بناءً على {reviewsCount} تقييم سابق
          </p>
        </div>
      </div>
