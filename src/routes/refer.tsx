  ...
  head: () => ({
    meta: [
      { title: "برنامج الإحالة — شارك واكسب خصم | اليسر ميديكال" },
      {
        name: "description",
        content:
          "شارك كود الإحالة الخاص بك مع أصدقائك واحصل على خصم عند كل طلب يتم عبر رابطك. نظام إحالة بسيط وآمن مع شحن سري لكل مصر.",
      },
    ],
  }),
  component: ReferPage,
  ...
  return (
    <div className="container mx-auto px-4 py-10 md:py-12">
      <PageHero
        ...
        title="شارك اليسر مع أصدقائك — الكل يكسب 🎁"
        description="كل عميل له كود إحالة فريد. شاركه واتساب، ولما صديقك يطلب عبر رابطك، هتاخد خصم تلقائي في طلبك الجاي. بسيط، آمن، وبدون أي بيانات شخصية في الكود."
      />
        ...
        <div className="rounded-[2rem] border border-primary/10 bg-gradient-soft p-6 md:p-8">
          ...
          <ol className="space-y-3">
            {[
              ...
              "عندما يطلب، يُسجل كودك في الطلب وستحصل على خصم في طلبك القادم",
            ].map((step, i) => (
