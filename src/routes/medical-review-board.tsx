...
function MedicalReviewBoardPage() {
  ...
  return (
    <div className="container mx-auto max-w-5xl px-4 py-10 md:py-14">
      <PageHero
        eyebrow="شفافية المحتوى"
        title="من يكتب المحتوى وكيف نتحقق منه"
        description="نلتزم بمحتوى صحي دقيق ومسؤول. هذه الصفحة تقول الحقيقة كما هي: من كتب المحتوى الأصلي، وكيف يتحقق الفحص الآلي (CI) من كل مقالة، ما المصادر المعتمدة، وأين حدود مسؤوليتنا — بما في ذلك ما لا نفعله."
      />

      {/* ─── العملية التحريرية ─── */}
      <section className="mt-10 rounded-[2rem] border bg-card p-6 shadow-card md:p-8">
        <h2 className="text-2xl font-black text-center mb-2">كيف ينشأ المحتوى ويُتحقق منه</h2>
        <p className="text-center text-sm text-muted-foreground mb-6 max-w-2xl mx-auto">
          الخطوات الحقيقية كما تتم فعلًا — من غير مبالغة
        </p>
          ...
          {[
            {
              ...
              icon: PenTool,
              t: "الكتابة",
              d: "المحتوى الأصلي كُتب من د. أحمد عيد (صيدلي ومؤسس الموقع) بمسؤوليته التحريرية المباشرة",
            },
            {
              step: "2",
              icon: Eye,
              t: "المعايير التحريرية",
              d: "مصادر طبية موثوقة، وتحذيرات استخدام واضحة، ولا وعود علاجية إطلاقًا",
            },
            {
              step: "3",
              icon: ShieldCheck,
              t: "الفحص الآلي (CI)",
              d: "فحص برمجي لكل مقالة: حيوية الروابط، موثوقية النطاقات، وجود التحذيرات، ومطابقة البيانات",
            },
            {
              step: "4",
              icon: Scale,
              t: "الامتثال",
              d: "تصنيف المنتجات (أخضر/أصفر/أحمر) وضبط مستوى الترويج والإعلانات",
            },
            {
              step: "5",
              icon: CalendarCheck,
              t: "النشر والتحديث",
              d: "نشر بتواريخ واضحة، وتحديث عند ظهور معلومات جديدة أو إبلاغ القارئ بخطأ",
            },
          ].map((s) => (
      ...
      <section className="mt-8 grid gap-6 md:grid-cols-2">
        <div className="rounded-[2rem] border bg-card p-6 shadow-sm">
          ...
          <div className="space-y-3 text-sm leading-7 text-muted-foreground">
            <p>
              <strong className="text-foreground">د. أحمد عيد — مؤسس اليسر ميديكال (صيدلي)</strong>
            </p>
            <p>
              المحتوى الأصلي في الموقع كُتب شخصيًا من د. أحمد عيد — بكالوريوس صيدلة — بمسؤوليته
              التحريرية المباشرة، ويعتمد على بيانات المنتجات الأصلية ومصادر طبية عامة موثوقة (WHO,
              Mayo Clinic, Cleveland Clinic, MedlinePlus) بصياغة عربية واضحة تناسب القارئ.
            </p>
            <p>
              المحتوى الجديد — بما في ذلك ما يُنجز بمساعدة الذكاء الاصطناعي — يُنشر تحت نفس
              المسؤولية التحريرية ونفس المعايير (مصادر موثوقة وتحذيرات واضحة)، ويمر بنفس الفحص الآلي
              مثل أي محتوى آخر.
            </p>
            <p>كل مقالة تحمل اسم كاتبها وتاريخ النشر وآخر تحديث.</p>
          </div>
        </div>
        <div className="rounded-[2rem] border bg-card p-6 shadow-sm">
          <ShieldCheck className="h-8 w-8 text-primary mb-3" />
          <h2 className="text-xl font-black mb-3">كيف نتحقق من المحتوى؟</h2>
          <div className="space-y-3 text-sm leading-7 text-muted-foreground">
            <p>
              <strong className="text-foreground">فحص آلي (CI) + مسؤولية تحرير المالك</strong>
            </p>
            <p>
              كل مقالة تمر بفحص برمجي آلي قبل وبعد النشر: حيوية روابط المصادر، موثوقية النطاقات
              (مؤسسات طبية رسمية)، وجود تحذيرات الاستخدام، ومطابقة البيانات المنظمة. الفشل في أي فحص
              يمنع النشر.
            </p>
            <div className="rounded-xl border border-amber-200 bg-amber-50 p-3 text-amber-900">
              <strong>ملاحظة شفافية — بما في ذلك ما لا نفعله:</strong> لا يوجد لدينا "لجنة مراجعة
              طبية" دائمة، ولا "فريق مراجعة داخلية" بالمعنى المؤسسي، ولا إعادة مراجعة دورية تلقائية
              للمقالات. مسؤولية كل المحتوى المنشور (بما في ذلك ما يُنجز بمساعدة الذكاء الاصطناعي)
              التحريرية تقع على د. أحمد عيد، وكله يمر بالفحص الآلي الموصوف أعلاه. إذا تم تعيين مراجع
              طبي أو صيدلي مرخّص في المستقبل، سيتم عرض اسمه ورقم ترخيصه هنا وعلى صفحات المقالات.
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="mt-8 rounded-[2rem] border bg-card p-6 shadow-card md:p-8">
        ...
        <p className="mt-4 text-xs text-muted-foreground text-center leading-6">
          كل مقالة تحتوي على قسم "المصادر" في نهايتها مع روابط مباشرة للمصادر المستخدمة. صلاحية
          الروابط تُفحص آليًا (في CI) في كل دورة نشر، وتُحدَّث عند التغيير أو عند إبلاغ القارئ برابط
          معطّل.
        </p>
      </section>
