          ...
          {[
            {
              ...
              icon: PenTool,
              t: "الكتابة",
              d: "المحتوى الأصلي كُتب من د. أحمد عابد (صيدلي ومؤسس الموقع) بمسؤوليته التحريرية المباشرة",
            },
            {
              step: "2",
              icon: Eye,
      ...
      <section className="mt-8 grid gap-6 md:grid-cols-2">
        <div className="rounded-[2rem] border bg-card p-6 shadow-sm">
          ...
          <div className="space-y-3 text-sm leading-7 text-muted-foreground">
            <p>
              <strong className="text-foreground">د. أحمد عابد — مؤسس اليسر ميديكال (صيدلي)</strong>
            </p>
            <p>
              المحتوى الأصلي في الموقع كُتب شخصيًا من د. أحمد عابد — بكالوريوس صيدلة — بمسؤوليته
        ...
        <div className="rounded-[2rem] border bg-card p-6 shadow-sm">
          ...
          <div className="space-y-3 text-sm leading-7 text-muted-foreground">
            ...
            <div className="rounded-xl border border-amber-200 bg-amber-50 p-3 text-amber-900">
              ...
              التحريرية تقع على د. أحمد عابد، وكله يمر بالفحص الآلي الموصوف أعلاه. إذا تم تعيين
              مراجع طبي أو صيدلي مرخّص في المستقبل، سيتم عرض اسمه ورقم ترخيصه هنا وعلى صفحات
              المقالات.
            </div>
          </div>
        </div>
