      ...
      <section className="mt-8 grid gap-6 md:grid-cols-2">
        <div className="rounded-[2rem] border bg-card p-6 shadow-sm">
          ...
          <div className="space-y-3 text-sm leading-7 text-muted-foreground">
            ...
            <p>
              إذا أُضيف محتوى مولّد آليًا في المستقبل، فسيُعلَن ذلك بوضوح في المقالة نفسها (بوصف
              "محتوى مولّد آليًا") ولن يُنسب لأي شخص.
            </p>
        ...
        <div className="rounded-[2rem] border bg-card p-6 shadow-sm">
          ...
          <div className="space-y-3 text-sm leading-7 text-muted-foreground">
            ...
            <div className="rounded-xl border border-amber-200 bg-amber-50 p-3 text-amber-900">
              ...
              للمقالات. مسؤولية المحتوى الأصلي التحريرية تقع على د. أحمد عيد شخصيًا، والمحتوى المضاف
              آليًا (إن وُجد) يتحقق منه الفحص الآلي فقط ويُعلَن كمولّد آليًا. إذا تم تعيين مراجع طبي
              أو صيدلي مرخّص في المستقبل، سيتم عرض اسمه ورقم ترخيصه هنا وعلى صفحات المقالات.
            </div>
          </div>
        </div>
      </section>
