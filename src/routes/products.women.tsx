...
export const Route = createFileRoute("/products/women")({
  ...
  head: () => ({
    meta: [
      { title: "منتجات النساء — اليسر ميديكال" },
      { name: "description", content: "منتجات صحية وجنسية وعناية للنساء بأسعار الاستيراد." },
    ],
  }),
  component: WomenPage,
});
    ...
    <div className="container mx-auto px-4 py-12">
      <header className="mb-10 text-center">
        ...
        <p className="mt-3 text-muted-foreground max-w-2xl mx-auto">
          منتجات عناية وصحة وجمال وتوازن هرموني مخصصة للمرأة العصرية.
        </p>
      </header>
