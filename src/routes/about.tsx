  ...
  head: () => ({
    meta: [
      { title: "من نحن — اليسر ميديكال | Elysr Medical Group" },
      {
        name: "description",
        content:
          "تعرف على اليسر ميديكال: الكتالوج، طريقة العمل، سياسة الخصوصية، والشحن السري لمنتجات الصحة الزوجية إلى 27 محافظة.",
      },
    ],
  }),
  component: AboutPage,
  ...
  return (
    <div className="container mx-auto px-4 py-10 md:py-14 max-w-5xl">
      <PageHero
        ...
        description="اليسر ميديكال شركة مصرية تعمل في عرض وتوزيع منتجات الصحة الزوجية. نوضح المكونات والاستخدام والتحذيرات المتاحة، ونوفر شحناً سرياً مع احترام خصوصية العملاء."
      />
