...
function AboutPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-10 md:py-14 max-w-5xl">
      <PageHero
        eyebrow="من نحن"
        title="اليسر ميديكال — أكبر شركة متخصصة"
        description="اليسر ميديكال أكبر شركة متخصصة في توفير منتجات الصحة الزوجية الأصلية للرجال والنساء في مصر، بكتالوج مختار بعناية، وصف واضح، شحن سري، ودفع عند الاستلام."
      />
        ...
        <div className="grid gap-4 md:grid-cols-2">
          {[
            ...
            },
            {
              icon: Truck,
              t: "توصيل لكل مصر",
              d: `${SHIPPING_DELIVERY_TEXT}. الدفع عند الاستلام — لا نطلب بيانات دفع إلكتروني.`,
            },
            {
              icon: Headphones,
              t: "دعم واتساب فوري",
