...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "اليسر ميديكال — أفضل شركة متخصصة في منتجات الصحة الزوجية الأصلية في مصر" },
      {
        name: "description",
        content:
      ...
      {
        property: "og:title",
        content: "اليسر ميديكال — أفضل شركة متخصصة في منتجات الصحة الزوجية الأصلية في مصر",
      },
      {
