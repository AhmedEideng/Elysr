  ...
  head: () => ({
    meta: [
      { title: "اليسر — منتجات الصحة الزوجية الأصلية في مصر" },
      {
        name: "description",
        content:
          "اليسر هو أكبر شركة متخصصة في منتجات الصحة الزوجية الأصلية للرجال والنساء في مصر. شحن سري 100%، دفع عند الاستلام، أكثر من 87 منتج مضمون ودعم متخصص على واتساب.",
      },
