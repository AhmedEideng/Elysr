 ...
 * ملاحظات:
 * - الأدوية المحذوفة (m-34,m-36,m-37,m-47,w-17) مفيش منها أي تثبيت.
 * - m-38/m-43/m-45 كانت مستثناة من التثبيت العلوي، وبقت غير محظورة
 *   بعد 2026-09-06 بس فضلوا خارج التثبيت (فك الحظر ≠ تثبيت).
 */
 ...
 * 5 أدوية اتحذفت نهائياً من الكتالوج (m-34,m-36,m-37,m-47,w-17).
 * من 2026-09-06 مفيش أي حظر: كل المنتجات (82) ظاهرة في الفئات عادي
 * ومن غير noindex ولا استبعاد من feed/sitemap (بما فيهم m-38/m-43/m-45
 * اللي اتفك عنهم الحظر بقرار المالك).
 */
