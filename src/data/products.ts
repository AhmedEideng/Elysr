 ...
 * ملاحظات:
 * - أربعة منتجات دوائية ما زالت محذوفة من الكتالوج: m-36,m-43,m-47,w-24.
 * - المنتجات الخمسة التي أعادها المالك (m-34,m-37,m-38,m-45,w-17)
 *   تُرتب وتظهر طبيعيًا مثل بقية الكتالوج.
 */
 ...
 * (التلاتة استبعاد تجاري/عرضي قديم، وليس حظرًا دوائيًا.)
 */
...
const HOME_FEATURED_ORDER = [
  ...
  "m-60", //  4. 🧴 جل كريفا الألماني المتطور للرجال (منتج التأخير الموضعي — إحساس مزدوج بدون تخدير)
 ...
 * المنتجات المحذوفة حاليًا: m-36 (Vegal)، m-43 (Procomil Fort)،
 * m-47 (Levitra)، وw-24 (Black Widow Drops).
 * مفيش أي حظر: كل المنتجات الحالية (84) ظاهرة في الفئات عادي ومن غير
