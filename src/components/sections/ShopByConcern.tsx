...
const concernCandidates = {
  delay: ["m-14", "m-19", "m-48", "m-05", "m-35"], // ملاحظة: استُبعدت المخدّرات الموضعية (m-44/m-30/m-55) لتوافق إعلانات جوجل
  strength: ["m-11", "m-02", "m-01", "m-04", "m-03", "m-49"],
  devices: ["d-01", "d-02", "d-03", "d-04", "d-05"],
  women: ["w-02", "w-15", "w-05", "w-01", "w-04", "w-16", "w-07"], // استُبعدت Spanish Fly (w-11/w-03) لارتباط الاسم بمادة محظورة
};
